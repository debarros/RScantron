...
FindMissingTests = function(RecentTestFrame, TAB.wb, TestFrame){
  ...
  if(length(missingTests) > 0){
    print("The following tests are missing from the TAB.")
    print(missingTests)
    print("You should add them by running UpdateTab.")
  } # /if
  ...
  if(nrow(badTests) > 0){
    print("The following tests have a different TestID in the TAB than in Scantron.")
    print(badTests)
