...
FindClasses = function(TeacherLookup, CourseLookup, agent = NULL, messageLevel = 0){
  ...
  # fetch the page with the list of classes
  x <- httr::content(
    httr::GET(url = url1, user_agent(agent)),
    as = "text",
    encoding = "UTF-8")
  ...
  # pull the csv of classes
  x <- httr::content(
    httr::GET(url = url2, user_agent(agent)),
    as = "text",
    encoding = "UTF-8")
